...
`grep -r "love" ~/Shakespeare/ > t.txt`

# Выводы

Я просмотрел курс и освежил в памяти навыки работы с архивами, папками, терминалом, скачивание файлов, команды grep в линуксе.
